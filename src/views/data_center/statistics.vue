          ...
          <el-tab-pane label="PV/UV" name="first">
            ...
            >
              ...
              <el-button-group>
                ...
                <el-button v-show="!shoudzy" @click="yesterday(0)"
                  >昨天</el-button
                >
                <el-button v-show="!shoudzy" @click="sevendat(0)"
                  >近7天</el-button
                >
                <el-button v-show="!shoudzy" @click="thirtyday(0)"
                  >近30天</el-button
          ...
          <el-tab-pane label="地区和运营商" name="second">
            ...
            >
              ...
              <el-button-group>
                ...
                <el-button v-show="!shoudzyx" @click="yesterday(1)"
                  >昨天</el-button
                >
                <el-button v-show="!shoudzyx" @click="sevendat(1)"
                  >近7天</el-button
                >
                <el-button v-show="!shoudzyx" @click="thirtyday(1)"
                  >近30天</el-button
          ...
          <el-tab-pane label="播放统计" name="there">
            ...
            >
              ...
              <el-button-group>
                ...
                <el-button v-show="!shoudzyz" @click="yesterday(2)"
                  >昨天</el-button
                >
                <el-button v-show="!shoudzyz" @click="sevendat(2)"
                  >近7天</el-button
                >
                <el-button v-show="!shoudzyz" @click="thirtyday(2)"
                  >近30天</el-button
