    ...
    <div class="content">
      <el-form :model="dynamicValidateForm" ref="dynamicValidateForm">
        <el-form-item
          ...
          prop="url_a"
          :rules="[{ required: true,validator: jiourl, trigger: 'blur' }]"
        >
          <el-input
            class="other_bgc"
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
          prop="url_name"
          :rules="[{ required: true,validator: jioshi, trigger: 'blur' }]"
        >
          <el-input
            class="other_bgc"
      ...
      <p>说明：用户可以自定义标签设置，标签设置为自选项，标签设置的作用是保护源站信息隐藏不被泄露，防止黑客攻击</p>
