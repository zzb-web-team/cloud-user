          ...
          <ol class="tala">
            ...
            <li>
              ...
              <span
                ...
                >{{ datalist.url }}</span
              >
              <span style="color: rgb(64, 158, 255);" @click="cleckurl"
                >查看</span
              >
            </li>
            <!--  -->
        ...
        <el-tab-pane label="回源配置" name="two">
          <div class="talb">
            ...
            >
              ...
              <el-button type="primary" @click="hosturl('hosturlref')"
                >确 定</el-button
              >
            </el-dialog>
          </div>
              ...
              <div class="batch_huan">
                ...
                <el-dialog title="配置缓存过期时间" :visible.sync="huanVisible">
                  ...
                  <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="huanVisib()"
                      >确 定</el-button
                    >
                  </div>
                </el-dialog>
                ...
                >
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="scope">
                      <el-button
                        @click="xhuanVisib(scope.row, scope.$index)"
                        type="text"
                        size="small"
                        >修改</el-button
                      >
            ...
            >
              <el-form :model="form" ref="form">
                <el-form-item
                  ...
                  prop="errCode"
                  :label-width="formLabelWidth"
                  :rules="[{ validator: jioerrcode, trigger: 'blur' }]"
                >
                  <el-input
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="zareVisible('form')"
                  >确 定</el-button
                >
              </div>
            </el-dialog>
          ...
          <div class="pei_zhi_tabel">
            ...
            >
              ...
              <el-table-column label="状态">
                <template slot-scope="scope">
                  <span style="color:#E54545" v-if="scope.row.state == 1"
                    >已停止</span
                  >
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button
                    ...
                    type="text"
                    size="small"
                    >{{ scope.row.state == 1 ? "启动" : "停止" }}</el-button
                  >
                  <el-button
                    type="text"
                    size="small"
      ...
      getterminal(parmas)
        .then(res => {
          res.result.cols.forEach((item, index) => {
            let obj = {};
            obj.value = item.id;
            obj.label = item.id + "--" +item.name + "--" + "(" + item.type + ")";
