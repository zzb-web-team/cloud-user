      ...
      <div class="con_lable">
        <div style="padding:10px 0 18px;display: flex;justify-content: space-between;">
          <div>
            ...
            <el-button type="primary" plain @click="upload_btn">批量导入加速内容</el-button>
            <!-- <el-button type="primary" plain @click="setdomainlist">批量管理标签</el-button> -->
          </div>
          <div>
            <el-button type="primary" @click="exp_table" style="width: 100px;">导出</el-button>
          </div>
        </div>
        <!-- 主体数据表格 -->
        <el-table
        ...
        >
          ...
          <el-table-column prop="url_name" label="加速内容名称"></el-table-column>
          <el-table-column
            prop="domain"
            label="源站域名"
            class-name="firsturl"
          ...
          <el-table-column prop="state" label="状态" width="120">
            <template slot-scope="scope">
              <span style="color:#0ABF5B;" v-if="scope.row.state == 1">正常运行</span>
        ...
        .then(res => {
          if (res.status == 0) {
            if (res.result.cols.length <= 0) {
              this.$alert("您还未添加终端，还不能操作域名！", "温馨提示", {
