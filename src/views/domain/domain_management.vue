      ...
      <div class="con_lable">
        ...
        >
          <div>
            ...
            <el-button type="primary" plain @click="upload_btn">
              批量导入URL
            </el-button>
            <el-button type="primary" plain @click="setdomainlist"
              >批量管理标签</el-button
            >
          </div>
        </div>
        ...
        >
          ...
          <el-table-column prop="status" label="状态" width="120">
            <template slot-scope="scope">
              <span style="color:#0ABF5B;" v-if="scope.row.status == 1"
                >正常运行</span
          ...
          <el-table-column label="操作" width="550">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" @click="updatauser(scope.row)"
                >复制配置</el-button
              >
              <el-button type="text" size="small" @click="pwdwetout(scope.row)"
                >监控</el-button
              >
              <el-button
                type="text"
        ...
        >
          <el-form :model="details">
            <el-form-item label="使用状态" :label-width="formLabelWidth">
              <el-radio v-model="radioes" label="1" :disabled="true"
                >启用</el-radio
              >
              <el-radio v-model="radioes" label="2" :disabled="true"
                >停用</el-radio
              >
            </el-form-item>
        ...
        >
          <div>
            <el-button type="text" size="small" @click="enableuser()"
              >启用</el-button
            >
            <el-button
              type="text"
              ...
              >停用</el-button
            >
            <el-button type="text" size="small" @click="deleateuser()"
              >删除</el-button
            >
