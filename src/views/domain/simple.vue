        ...
        >
          <el-table-column label="URL" prop="url" width="280px">
            <template slot-scope="scope">
              <span style="color:red" v-if="scope.row.err == false">{{ scope.row.url }}</span>
          ...
          <el-table-column prop="url_name" label="视频名称">
            <template slot-scope="scope">
              <span
                style="color:red"
                v-if="scope.row.err_url_name == false"
          ...
          <el-table-column prop="url_type" label="视频类型(0:mp4 1:hls 2:flv)" width="210px">
            <template slot-scope="scope">
              <span
                style="color:red"
          ...
          <el-table-column label="上传状态">
            <template slot-scope="scope">
              ...
              <span v-else-if="scope.row.status == '待上传'" style="color:grey">待上传</span>
