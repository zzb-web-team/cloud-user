            ...
            >
              <el-form :model="tokene" ref="tokene">
                ...
                >
                  <el-input
                    v-model="tokene.name"
                    placeholder="英文或汉字，30 字符内"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
                <el-form-item label="类型：" :label-width="formLabelWidth">
                  <el-select
                    v-model="tokene.region"
                    placeholder="请选择终端类型"
              ...
              <el-table-column label="token">
                <template slot-scope="scope">
                  <el-button
                    ...
                    >{{ scope.row.sea !== false ? "收起" : "查看" }}</el-button
                  >
                  <div v-if="scope.row.sea !== false">
                    <p @click="deleteRow(scope.$index, tableData)">
              ...
              <el-table-column label="操作" width="240">
                <template slot-scope="scope">
                  <el-button
                    type="text"
                    size="small"
                    @click="showtab(scope.$index, scope.row)"
                    >设置</el-button
                  >
                  <el-button
                    type="text"
                    size="small"
                    @click="dettab(scope.$index, scope.row)"
                    >删除</el-button
                  >
                </template>
              </el-table-column>
        ...
        <el-tab-pane label="SDK下载" name="second">
          ...
          >
            ...
            >
              ...
              >
              <!-- <el-table-column label="SDK" width="320">
                <template slot-scope="scope">
                  <el-button
                    type="text"
                    size="small"
                    @click.native.prevent="deletesdk(scope.$index, tableData)"
                    >查看</el-button
                  >
                  <div v-if="scope.row.sea !== false">{{ scope.row.sdk }}</div>
                </template>
              </el-table-column> -->
